...
import com.example.practicefornike1.data.repository.source.CLIENT_ID
import com.example.practicefornike1.data.repository.source.CLIENT_SECRET
...
class NikeAuthenticator : Authenticator, KoinComponent {
    ...
    fun refreshToken(): String {
        val response: retrofit2.Response<TokenResponce> =
